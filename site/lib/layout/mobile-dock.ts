...
export const MOBILE_STICKY_DOCK_CLASS =
  "fixed inset-x-0 bottom-0 z-40 border-t border-hairline bg-canvas px-4 pt-4 pb-[calc(1rem+env(safe-area-inset-bottom,0px))] [backface-visibility:hidden] [-webkit-backface-visibility:hidden] [transform:translate3d(0,0,0)] md:hidden";
...
export const MOBILE_STICKY_DOCK_SHELL_HEIGHT =
  "calc(1rem + 56px + 0.5rem + 5rem + 1rem + env(safe-area-inset-bottom,0px) + 1px)";
...
export const MOBILE_STICKY_LAYOUT_BOTTOM_PAD_CLASS =
  "max-md:pb-[max(12rem,calc(1rem+56px+0.5rem+5rem+1rem+env(safe-area-inset-bottom,0px)+1px))]";
