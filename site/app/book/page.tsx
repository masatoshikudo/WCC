  ...
  return (
    <>
      <section aria-label="ご相談のご案内">
        <div className="mx-auto w-full max-w-content px-4 pt-12 md:px-6 md:pt-16 lg:px-8">
          <p className="max-w-2xl font-body text-base leading-relaxed text-ink-muted md:text-lg">
            日程が決まっていなくても、式場が確定していなくても、まずはお知らせください。
          </p>
          <p className="mt-3 font-body text-sm leading-relaxed text-ink-muted md:text-base">
