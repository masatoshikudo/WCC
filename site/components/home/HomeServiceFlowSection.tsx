...
const PHASES: FlowPhase[] = [
  {
    ...
    steps: [
      {
        title: "お問い合わせ",
        body: "まずは「ご相談フォーム」より、日程や会場、ご希望のイメージをお知らせください。日程が未定の段階でも、ご相談いただけます。",
      },
      {
      ...
      },
      {
        ...
        body: "お二人のご要望や、当日のスケジュール、残したいシーンについて詳しくお伺いします。不安な点があれば、何でもご質問ください。",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "挙式当日",
        body: "担当クリエイターがお二人のそばに同行し、当日の高まりをそのままiPhoneで記録します。ハイライト動画は当日中〜翌日にはお届けしますので、すぐに皆様にお送りできます。",
      },
    ],
  },
];
